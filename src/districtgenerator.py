...
class Sun():
    ...
    def getSolarGains(self, initialTime, timeDiscretization, timeSteps, timeZone,
        ...
        geometry = self.getGeometry(initialTime, timeDiscretization,
        ...
        for i in range(len(gamma)) :
            ...
            radiation = self.getTotalRadiationTiltedSurface(theta,thetaZ,beam,
                                                       diffuse,airmass,Gon,
                                                       beta[i],albedo)
    ...
    def getTotalRadiationTiltedSurface(self, theta,thetaZ,
